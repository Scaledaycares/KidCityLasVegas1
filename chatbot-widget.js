...
function sendInputToGAS3(message, isUserMessage) {
    const GAS_URL3 = 'https://script.google.com/macros/s/AKfycbyZ24ZDIrI28OUy-dc4BQqDOXcMD-IvMIYdfrdxPQdxfIeyD0LX2ASP3MeTkeHfyl7p/exec'; // Replace with your actual URL
...
function startConversation() {
    fetch('https://chatbot-for-kids-city-usa-las-vegas-1-samuelsicking.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
    ...
    fetch('https://chatbot-for-kids-city-usa-las-vegas-1-samuelsicking.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGAS(message, isUserMessage) {
    var GAS_URL = 'https://script.google.com/macros/s/AKfycbw9IqlXOG3DA3rQOByr_VsWI8AM1DEYTrp8lOrWb3bv3xTXAGhUF0MoM8wEob75ikCo/exec';
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbwlA0S28I9hg93PWxnbG9VosJGOwqU4gMEgkR3tGdSiHnBmPrAto7X1V-pvZ9_jEJ-i0A/exec';
